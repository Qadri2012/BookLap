          ...
          >
            {showForgot ? (
              ...
              <div style={{ animation: "fadeSlideUp 0.4s both" }} key={isSignUp ? "reg" : "log"}>
                ...
                <div
                  className={isSignUp ? "field-anim" : ""}
                  style={isSignUp ? { animationDelay: "80ms" } : {}}
                >
                  <Field
                    label="Email"
                    type="email"
                    ...
                    onChange={(e) =>
                      isSignUp ? setREmail(e.target.value) : setLEmail(e.target.value)
                    }
                    maxLength={254}
                ...
                <div
                  className={isSignUp ? "field-anim" : ""}
                  style={isSignUp ? { animationDelay: "120ms" } : {}}
                >
                  <Field
                    label="Password"
                    type={
                      isSignUp ? (rShowP ? "text" : "password") : lShowP ? "text" : "password"
                    }
                    placeholder={isSignUp ? "Password (min. 8 karakter)" : "Password"}
                    value={isSignUp ? rPass : lPass}
                    onChange={(e) =>
                      isSignUp ? setRPass(e.target.value) : setLPass(e.target.value)
                    }
                    maxLength={128}
                    ...
                    right={
                      <span
                        onClick={() =>
                          isSignUp ? setRShowP(!rShowP) : setLShowP(!lShowP)
                        }
                      >
